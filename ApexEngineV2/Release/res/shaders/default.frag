...
void main()
{
  ...
  vec3 diffuseCubemap = textureCube(env_GlobalCubemap, n, mipLevel).rgb;
  vec3 specularCubemap = textureCube(env_GlobalCubemap, ReflectionVector(n, v_position.xyz, u_camerapos.xyz), mipLevel).rgb;
