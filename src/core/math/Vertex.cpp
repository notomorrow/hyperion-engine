...
const decltype(VertexAttribute::mapping) VertexAttribute::mapping({ { MESH_INPUT_ATTRIBUTE_POSITION, VertexAttribute { .name = "a_position", .location = 0, .binding = 0, .size = 3 * sizeof(float) } },
