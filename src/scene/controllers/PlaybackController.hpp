...
public:
    ...
    bool IsPlaying() const
        { return m_state.playback_state == PlaybackState::PLAYING; }

    bool IsPaused() const
        { return m_state.playback_state == PlaybackState::PAUSED; }

    bool IsStopped() const
        { return m_state.playback_state == PlaybackState::STOPPED; }
