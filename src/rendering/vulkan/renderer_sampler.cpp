...
RendererSampler::RendererSampler(Texture::TextureFilterMode filter_mode, Texture::TextureWrapMode wrap_mode)
    : m_sampler(nullptr),
...
RendererResult RendererSampler::Create(RendererDevice *device, RendererImageView *image_view)
{
    ...
    sampler_info.maxAnisotropy = device->GetRendererFeatures().GetPhysicalDeviceProperties().limits.maxSamplerAnisotropy;
...
VkSamplerAddressMode RendererSampler::ToVkSamplerAddressMode(Texture::TextureWrapMode texture_wrap_mode)
{
