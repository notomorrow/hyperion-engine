...
HYP_DESCRIPTOR_SRV_COND(View, PostFXPreStack, 4, g_renderBackend->GetRenderConfig().IsDynamicDescriptorIndexingSupported());
HYP_DESCRIPTOR_SRV_COND(View, PostFXPostStack, 4, g_renderBackend->GetRenderConfig().IsDynamicDescriptorIndexingSupported());
