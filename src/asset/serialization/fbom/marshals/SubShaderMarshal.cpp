...
public:
    ...
    {
        out.SetProperty(NAME("type"), FBOMData::FromUInt32(in_object.type));
        out.SetProperty(NAME("bytes"), FBOMSequence(FBOMUInt8(), in_object.spirv.bytes.Size()), in_object.spirv.bytes.Data());
