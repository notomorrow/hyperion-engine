...
void main(void)
{
    ...
    vec3 probe_world_position_offset = world_position.xyz - ((env_probe.aabb_max.xyz - env_probe.aabb_min.xyz) * 0.5);
    ...
    vec3 scaled_position = (probe_world_position_offset - voxel_grid_aabb_center) / voxel_grid_aabb_extent;
